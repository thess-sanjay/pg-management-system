...
public class TenantService {
    ...
    public Tenant saveTenant(Tenant tenant) {
        ...
        if (tenant.getAadharNumber() != null
                && !tenant.getAadharNumber().isBlank()
                && tenantRepository.existsByAadharNumber(
                        tenant.getAadharNumber())) {

            throw new DuplicateTenantException(
                    "Tenant with Aadhaar number "
                    + tenant.getAadharNumber()
                    + " already exists"
            );
        }
    ...
    public Tenant updateTenant(Long id, Tenant updatedTenant) {
        ...
        existingTenant.setAadharNumber(updatedTenant.getAadharNumber());
        existingTenant.setProfilePicture(updatedTenant.getProfilePicture());
